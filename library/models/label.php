 ...
 *	@property string $group	Used only for sorting labels, can be blank (not recommended)
 *	@property string $cs
 *	@property string $en
 */
class Art_Model_Label extends Art_Abstract_Model_DB {
    
    protected static $_table = 'label';
    
    protected static $_cols = array('id'			=>  array('select','insert'),
                                    'key'			=>  array('select','insert'),
                                    'group'			=>  array('select','insert','update'),
	...
	/**
	 *	Get all labels ordered by group
	 *	
	 *	@static
	 *	@return array
	 */
	static function fetchAllOrdered()
	{
		return self::fetchAll(NULL, 'group');
	}
}