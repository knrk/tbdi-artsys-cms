...
class Module_Bootstrap_Registration extends Art_Abstract_Module_Bootstrap {
	...
	{
		Art_Router::addRoute('route_forgotten_login', '/forgotten', ['layer'=>Art_Router::LAYER_FRONTEND,'section'=>'registration','action'=>'forgotten']);
		Art_Router::addRoute('route_forgotten_login_acknowledge', '/forgottenAck/$1', ['layer'=>Art_Router::LAYER_FRONTEND,'section'=>'registration','action'=>'forgottenAck','id'=>'$1']);
		Art_Router::addRoute('route_register_via_inv_code', '/invitation', ['layer'=>Art_Router::LAYER_FRONTEND,'section'=>'registration','action'=>'index','id'=>'$1']);
	}
